/****************************************************************************
** Meta object code from reading C++ file 'TextDisplayDataModel.hpp'
**
...
#include <memory>
#include "../../../../../examples/example2/TextDisplayDataModel.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TextDisplayDataModel.hpp' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject TextDisplayDataModel::staticMetaObject = { {
    QMetaObject::SuperData::link<NodeDataModel::staticMetaObject>(),
    qt_meta_stringdata_TextDisplayDataModel.data,
    qt_meta_data_TextDisplayDataModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
