...
#include <memory>
#include "../../../../../examples/styles/models.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyDataModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyDataModel_t qt_meta_stringdata_MyDataModel = {
    {
QT_MOC_LITERAL(0, 0, 11) // "MyDataModel"
...
QT_INIT_METAOBJECT const QMetaObject MyDataModel::staticMetaObject = { {
    QMetaObject::SuperData::link<NodeDataModel::staticMetaObject>(),
    qt_meta_stringdata_MyDataModel.data,
