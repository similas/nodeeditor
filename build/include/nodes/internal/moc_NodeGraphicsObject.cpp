...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtNodes__NodeGraphicsObject_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtNodes__NodeGraphicsObject_t qt_meta_stringdata_QtNodes__NodeGraphicsObject = {
    {
QT_MOC_LITERAL(0, 0, 27) // "QtNodes::NodeGraphicsObject"
...
QT_INIT_METAOBJECT const QMetaObject QtNodes::NodeGraphicsObject::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsObject::staticMetaObject>(),
    qt_meta_stringdata_QtNodes__NodeGraphicsObject.data,
